...
namespace Broccoli.Catalog
{
	...
	public class BroccoliCatalog {
		...
		/// <summary>
		/// The catalog extension path (ex. Assets/Waldemarst/Broccoli).
		/// </summary>
		public string extensionPath = ExtensionManager.extensionPath;
		/// <summary>
		/// Gets the catalog asset path.
		/// </summary>
		/// <value>The catalog asset path.</value>
		private string catalogAssetPath { get { return extensionPath + catalogAssetRelativePath; } }
		#endregion
