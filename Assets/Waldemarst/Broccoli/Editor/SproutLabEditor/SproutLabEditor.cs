...
namespace Broccoli.BroccoEditor
{
	...
	public class SproutLabEditor {
		...
		public void SetBranchDescriptorCollectionImpl (int descriptorImpl, BranchDescriptorCollection collectionToLoad = null) {
			viewMode = ViewMode.Structure;
			if (collectionToLoad == null) {
				SproutCatalog.CatalogItem firstItem = catalog.GetFirstItem ();
				LoadCatalogItem (firstItem);
			} else {
				collectionToLoad.descriptorImplId = descriptorImpl;
